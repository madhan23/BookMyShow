...
import com.bookmyShow.model.BookingTicket;
import com.bookmyShow.model.Genre;
import com.bookmyShow.model.GuestUser;
import com.bookmyShow.model.Language;
import com.bookmyShow.model.Movie;
import com.bookmyShow.model.RegisteredUser;
import com.bookmyShow.model.Show;
import com.bookmyShow.model.Theater;
import com.bookmyShow.model.TicketBookingThread;
...
public class BookMyShowApp {
    ...
    public static void main(String[] args) {
        ...
        BookMyShowApp bookMyShow = new BookMyShowApp(theaterArrayList);

        // Searching Book My Show for all the shows of movie WALK TO REMEMBER
        ArrayList<Show> searchedShow = BookMyShowApp.searchShows("The Walk To Remember");
       ...
       // Start both the Ticket Booking Threads for execution
        ...
        BookingTicket ayush_ticket = t1.getTicket();
        BookingTicket saurabh_ticket = t2.getTicket();
        ...
        BookingTicket ayushNewTicket = t3.getTicket();
        BookingTicket saurabhNewTicket = t4.getTicket();
